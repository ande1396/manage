class Subject < ActiveRecord::Base
	...
	} # in irb, subject.search("tayyy ")
	scope :position, lambda { where(:position => 3) }
	#scope :newest lambda { order("subjects.id DESC")}
end
